...
def test_valid_endpoint():
    assert app._valid_endpoint('192.168.10.88', 'backupuser', 22) is None
    assert app._valid_endpoint('host.local', 'backup', '2222') is None
    assert app._valid_endpoint('a b', 'backupuser', 22) == 'Invalid host'
    assert app._valid_endpoint('192.168.10.88', '', 22) == 'Invalid remote user'
    assert app._valid_endpoint('192.168.10.88', 'backupuser', 0) == 'Invalid port'
    assert app._valid_endpoint('192.168.10.88', 'backupuser', 70000) == 'Invalid port'
    assert app._valid_endpoint('192.168.10.88', 'backupuser', 'xx') == 'Invalid port'
