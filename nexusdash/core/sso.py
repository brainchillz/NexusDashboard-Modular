...
OFF unless DASHBOARD_SSO_ISSUER is set, and off is the default everywhere. A
...
from .config import env_bool, APP_DIR, write_json_atomic
from . import ed25519
...
SSO_ISSUER = os.environ.get('DASHBOARD_SSO_ISSUER', '').rstrip('/')
SSO_PUBKEY = os.environ.get('DASHBOARD_SSO_PUBKEY', '')
SSO_KID = os.environ.get('DASHBOARD_SSO_KID', '')
...
# registers.
SSO_AUDIENCE = os.environ.get('DASHBOARD_SSO_AUDIENCE', '')
...
SSO_AUTO_REDIRECT = env_bool('DASHBOARD_SSO_AUTO_REDIRECT', False)
...
STORE = os.path.join(APP_DIR, 'sso.json')
